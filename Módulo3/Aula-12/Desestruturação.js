...
console.log(desenvolvedor.nome, desenvolvedor.idade)
console.log(desenvolvedor.contato.email)
console.log(desenvolvedor.contato.endereco)

const [Website, AppMobile, API] = desenvolvedor.projetos
console.log(Website, AppMobile)
